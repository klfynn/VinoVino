        ...
        <Pressable style={styles.sheet} onPress={(e) => e.stopPropagation()}>
          ...
          <View style={styles.presetRow}>
            {PRESETS.map((p) => (
              <TouchableOpacity
                key={p}
                style={[styles.preset, qty === p && styles.presetActive]}
                onPress={() => setQty(p)}
              >
...
const styles = StyleSheet.create({
  ...
  handle: {
    width: 44, height: 4, backgroundColor: colors.border, borderRadius: 2,
  ...
  preset: {
    ...
    borderWidth: 1, borderColor: colors.border, minWidth: 56, alignItems: 'center',
  },
